...
interface ProjectStore {
  ...
  createProject: (body: { clientName: string; description: string }) => Promise<void>;
  createCampaign: (body: { project_id: string; title: string; url: string }) => Promise<void>;
  createLink: (body: { project_id: string; campaign_id: string; title: string }) => Promise<void>;

  updateProject: (id: string, body: { clientName: string; description: string }) => Promise<void>;
  updateCampaign: (id: string, body: { title: string; url: string }) => Promise<void>;
